          ...
          <div className="liquid-glass md:col-span-7 flex flex-col justify-center p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <a
                ...
                className="group flex items-center gap-4 p-4 transition-all hover:bg-white/3 border border-white/5 rounded-2xl"
              >
            ...
            <div className="liquid-glass p-8 flex-1 flex flex-col justify-between border border-white/5">
              ...
              <div className="mt-8 space-y-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between rounded-xl bg-white/2 p-4 border border-white/5 transition-all hover:bg-white/5 group"
                >
